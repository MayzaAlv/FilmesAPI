...
namespace FilmesAPI.Controllers
{
    ...
    public class EnderecoController : ControllerBase
    {
        ...
        public IActionResult AdicionarEndereco([FromBody] CreateEnderecoDto enderecoDto)
        {
            ...
            return CreatedAtAction(nameof(MostrarEnderecosPorId), new { Id = readDto.Id }, readDto);
        }

        [HttpGet]
        public IActionResult MostrarEnderecos()
        {
            List<ReadEnderecoDto> readDto = _enderecoService.MostrarEnderecos();
            if (readDto == null)
            {
                return NotFound();
            }
        ...
        [HttpGet("{id}")]
        public IActionResult MostrarEnderecosPorId(int id)
        {
            ReadEnderecoDto readDto = _enderecoService.MostrarEnderecosPorId(id);
            if (readDto == null)
            {
                return NotFound();
            }
